<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="post-entry">
		...
		<?php echo do_shortcode('[site_reviews_summary hide=bars show_if_empty=false assigned_to=post_id]')?>
		<?php wp_link_pages(); ?>
	...
	<?php echo do_shortcode('[site_reviews assigned_to=post_id title="Our Reviews" show_if_empty=false hide=date,title]')?>
	<?php echo do_shortcode('[site_reviews_form title="Submit a Review" hide=terms assign_to=post_id]'); ?>
	</div>
	<?php } ?>
